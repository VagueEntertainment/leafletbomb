...
Router.route('/release/:docId', {
            name: 'postsList',
                waitOn: function() { 
                                        ...
                                        return Meteor.subscribe('posts',showpost),Meteor.subscribe('images'),Meteor.subscribe('postassets'),Meteor.subscribe('postengagement',this.params.docId),Meteor.subscribe('influencers');}
            });    
            ...
            name: 'postCtrl',
                waitOn: function() { 
                                     var showpost = "all";
                                        ...
                                        return Meteor.subscribe('posts',showpost),Meteor.subscribe('images'),Meteor.subscribe('postassets'),Meteor.subscribe('influencers'),Meteor.subscribe('postengagement',this.params.docId),Meteor.subscribe('distrolist',this.params.userId),Meteor.subscribe('postdistribution'),Meteor.subscribe('postengagement');}
            });                              

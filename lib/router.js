...
Router.route('/dashboard/:userId', {
    ...
    waitOn: function() { return Meteor.subscribe('posts',this.params.userId),Meteor.subscribe('companies',this.params.userId),Meteor.subscribe('companyassets'),Meteor.subscribe('influencers'),Meteor.subscribe('distrolist',this.params.userId),Meteor.subscribe('images'),Meteor.subscribe('prteam',this.params.userId);}
    });
...
Router.route('/dashboard/:userId/newPressRelease', {
    ...
    waitOn: function() { return Meteor.subscribe('posts',this.params.userId),Meteor.subscribe('companies',this.params.userId),Meteor.subscribe('images'),Meteor.subscribe('postassets'),Meteor.subscribe('companyassets'),Meteor.subscribe('distrolist',this.params.userId);}
    });    
...
Router.route('/company/:companyName', {
            name: 'companyPage',
                waitOn: function() { return Meteor.subscribe('posts','all'),Meteor.subscribe('images'),Meteor.subscribe('postassets'),Meteor.subscribe('companies',this.params.companyName);}
            });         
